...
//# sourceMappingURL=row.view.tree.d.ts.map
declare namespace $ {
    const $go_rock_dao_base: Omit<typeof $hyoo_crus_dict, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_dict, {
...
//# sourceMappingURL=list.view.tree.d.ts.map
declare namespace $ {
    const $go_user_dao_base: Omit<typeof $hyoo_crus_dict, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_dict, {}>) & {
        schema: {
            [x: string]: typeof $hyoo_crus_node;
        };
    };
